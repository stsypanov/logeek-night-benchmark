...
public class COWList<E> implements List<E>, RandomAccess, ConcurrentList<E> {
    ...
    static {
        try {
            handle = MethodHandles.lookup()
                    .in(COWList.class)
                    .findVarHandle(COWList.class, "array", Object[].class);
    ...
    public Iterator<E> iterator() {
        ...
        return new COWList.COWIterator(elements, 0);
    }
    ...
    public ListIterator<E> listIterator(final int index) {
        ...
        return elements.length == 0 ? Collections.emptyListIterator() : new COWList.COWIterator(elements, index);
    }
