...
public class OriginalSmartList<E> extends AbstractList<E> implements RandomAccess {
  ...
  public OriginalSmartList() { }

  public OriginalSmartList(E element) {
    add(element);
  }

  public OriginalSmartList( Collection<? extends E> elements) {
  ...
  public OriginalSmartList( E... elements) {
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof OriginalSmartList) {
      return equalsWithSmartList((OriginalSmartList)o);
    }
  ...
  private boolean equalsWithSmartList(OriginalSmartList that) {
